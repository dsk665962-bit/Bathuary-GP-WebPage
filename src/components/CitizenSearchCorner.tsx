...
export const CitizenSearchCorner: React.FC<CitizenSearchCornerProps> = ({
  ...
  const searchResults = trimmed
    ? beneficiaries.filter(b => 
        b.colH.toLowerCase().includes(trimmed) ||
        b.colJ.toLowerCase().includes(trimmed) ||
        (b.colAF && b.colAF.toLowerCase().includes(trimmed)) ||
        (b.colAG && b.colAG.toLowerCase().includes(trimmed)) ||
        b.colP.toLowerCase().includes(trimmed) ||
        b.colQ.toLowerCase().includes(trimmed) ||
        b.colV.toLowerCase().includes(trimmed)
      ).slice(0, 15)
    : [];
